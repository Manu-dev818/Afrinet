<div class="main-panel">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">KSHs {{$total_ravenue}}</h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Total Ravenue</h6>
                  </div>
                </div>
              </div>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">© Afrinet Telecom Limited - 2025 All Rights Reserved</span>
